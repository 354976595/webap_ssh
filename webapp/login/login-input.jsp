...
<div class="container">
    <form class="form-signin" action="login/login!signIn.action" method="post" >
        <h2 class="form-signin-heading">Map And BB</h2>
...
<div style="background-color: lavender;height: 200px;width: 200px" >
    <label>123321</label> <div style="background-color: khaki;height: 100px;width: 100px" ></div>   <label>123321</label>    <label>123321</label>
